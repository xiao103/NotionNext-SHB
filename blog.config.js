...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '生本教具', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一切以学生为根本！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.x1ao.shop', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生本,教具,学具,生本教具,项目化,跨学科实践', // 网站关键词 英文逗号隔开
